...
export async function executeToolCall(
  ...
  const toolSelectionResponse = await generateText({
    ...
    system: `You are an intelligent finance assistant that analyzes conversations to select the most appropriate tools and their parameters.
            ...
            IMPORTANT: You are a SUPER FINANCE ASSISTANT. You can ONLY process queries about:
            ...
            If a query is outside of trading, investment, finance, or fintech topics, do not execute any tools and respond with an empty tool call.
